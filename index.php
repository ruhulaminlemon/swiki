                ...
                <div class="row">
                    <div class="col-md-12 jumbotron">
                            <h2 style="text-align: center;">
                                S-WIKI </h2>
                                <P><span style="float: right;"><a href="login.php" class="btn btn-info btn-lg">Admin Login</a></span>
</P>
                    </div>
                </div>
            </div>

            <div class="student-info text-center"><br /><br /> <br /><br /> <center>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12 jumbotron">
                            <h2>Student's information</h2><br /><br />
